...
\begin{document}
    ...
    The first 4 pages are background and sources, for the suggested rules go to page 5.
    ...
    *Might involve a rival
    ...
    A spell scroll can be crafted as with any magic item. The base gold cost depends solely on the level of the spell inscribed per the XGE guide. The time it takes is then calculated by the normal downtime crafting rules. 
    
    Any consumable material components are consumed upon crafting and non consumables are needed throughout the scribing process but are not consumed. 
    Both needs to be acquired on their own, outside the crafting of the scroll.

    The final cost to be paid can be reduced down by 25\% with proficiency in an appropriate tool \& by an additional 25\% with proficiency in arcana.

    To be eligible to craft a spell scroll you must have the spell prepared throughout the crafting time. 

    \large \textit{Spell Scroll Costs} \normalsize

    \begin{tabular}{|clr|}
        \hline
        Spell Level	&Time	&Cost\\\hline
        Cantrip	&0  days	&15 gp\\\hline
        1st	    &0  days	&25 gp\\\hline
        2nd	    &3  days	&250 gp\\\hline
        3rd	    &7  days 	&500 gp\\\hline
        4th	    &17 days    &2,500 gp\\\hline
        5th	    &23 days    &5,000 gp\\\hline
        6th	    &27 days    &15,000 gp\\\hline
        7th	    &31 days    &25,000 gp\\\hline
        8th	    &?? days    &50,000 gp\\\hline
        9th	    &?? days    &250,000 gp\\\hline
    \end{tabular}

    \subsection*{Spellwrought tatoos}

    The difference between a tattoo and a spellscroll is the ability to cast it without the inscribed spell being on your spell list. 
    Which is frankly a huge upside, especially towards martial characters. I suggest price multiplier to balance this out. In this example a 3x multiplier has been added.

    \large \textit{Spellwrought tatoo needle Costs} \normalsize

    \begin{tabular}{|clr|}
        \hline
        Spell Level	&Time	&Cost\\\hline
        Cantrip	&0  days	&45 gp\\\hline
        1st	    &1  day 	&75 gp\\\hline
        2nd	    &7  days	&750 gp\\\hline
        3rd	    &11 days 	&1,500 gp\\\hline
        4th	    &23 days    &7,500 gp\\\hline
        5th	    &27 days    &15,000 gp\\\hline
    \end{tabular}
